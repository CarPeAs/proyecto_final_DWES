...
if(isset($_GET['baja'])){
   ...
   $mensaje[]='El artículo ahora NO esta disponible en la web';
}
...
if(isset($_GET['alta'])){
   ...
   $mensaje[]='El artículo ahora esta disponible en la web';
...
if(isset($_GET['borrar'])){
   ...
   header('location:catalogo_emple.php');
}
...
<section class="show-products">
   ...
   <div class="box">
      ...
      <div class="flex-btn">
         <a href="editar_articulo.php?actualizar=<?= $fetch_articulos['id']; ?>" class="option-btn">editar</a>
         <a href="catalogo_emple.php?baja=<?= $fetch_articulos['id']; ?>" class="delete-btn" onclick="return confirm('¿Quiere dar de baja este artículo?');">baja</a>
      </div>
      <div class="flex-btn">
         <a href="catalogo_emple.php?alta=<?= $fetch_articulos['id']; ?>" class="btn" onclick="return confirm('¿Quiere dar de alta este artículo?');">alta</a>
      </div>
   </div>
   <?php
         }
